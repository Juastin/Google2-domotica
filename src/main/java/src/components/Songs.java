...
public class Songs {
    ...
    private Integer[] nummer1 = {NOTE_E5, 4,  NOTE_B4,8,  NOTE_C5,8,  NOTE_D5,4,  NOTE_C5,8,  NOTE_B4,8,
    ...
    public Integer[] getNummer1() {
        return nummer1;
    }

    public Integer[] getBloodytears() {
        return bloodytears;
    }
}
